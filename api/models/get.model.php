...
class GetModel{
	...
	static public function getDataFilter($table, $select, $linkTo, $equalTo, $orderBy,$orderMode,$startAt,$endAt){
        error_log('En get.model');
		error_log('la tabla es::'.$table);
		error_log('buscando el token');
		/*=============================================
		Validar existencia de la tabla y de las columnas
		=============================================*/
	...
	static public function getDataSearch($table, $select, $linkTo, $search,$orderBy,$orderMode,$startAt,$endAt){
        error_log("en data getDataSearch");
		/*=============================================
		Validar existencia de la tabla y de las columnas
		=============================================*/
        //error_log($linkTo);
		...
		//error_log($sql);
		$stmt = Connection::connect()->prepare($sql);
        //error_log("IIIIIIIIIIIIIIIII".$searchArray[0]);
        ...
        //error_log("el resultado::".json_encode($re));
		return $re;
	...
	static public function getDataRange($table,$select,$linkTo,$between1,$between2,$orderBy,$orderMode,$startAt,$endAt, $filterTo, $inTo){
        error_log("en getModel::getDataRange::9999999999999");
		/*=============================================
		Validar existencia de la tabla y de las columnas
		=============================================*/
		error_log($table);
		...
		if(empty(Connection::getColumnsData($table,$selectArray ))){
			error_log('no hay conexion');
			return null;

		}
        error_log('paso con conexion establecida.');
		$filter = "";

		if($filterTo != null && $inTo != null){
            error_log('Hay filterTo y intoTo');
		...
		$rt = $stmt -> fetchAll(PDO::FETCH_CLASS);
		error_log("el resultado de sql es::");
	...
	static public function getRelDataRange($rel,$type,$select,$linkTo,$between1,$between2,$orderBy,$orderMode,$startAt,$endAt, $filterTo, $inTo){
		...
		if(count($relArray)>1){
            ...
            error_log("La sentencia queda:::".$sql);
			$stmt = Connection::connect()->prepare($sql);
			...
			try{
                ...
                error_log("EEEEEError datos:::".json_encode($Exception));
				return null;
